...
function renderTerrainMission(){
  ...
  h+='<p style="font-weight:600;color:#0369a1;margin-bottom:8px;font-size:13px;">ðŸ“¦ Co-prÃ©lÃ¨vement d\'agents (mÃªme support)</p>';
  ...
  h+='<p style="font-weight:600;color:#92400e;margin-bottom:8px;font-size:13px;">ðŸ”— Fusion de prÃ©lÃ¨vements</p>';
