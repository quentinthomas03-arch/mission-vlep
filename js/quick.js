/*
 * VLEP Mission v3.8 - quick.js
 * © 2025 Quentin THOMAS - Tous droits réservés
 *
 * Module Saisie rapide :
 * - Création mission directe depuis le terrain (sans prépa)
 * - Formulaire client/site, GEH, agents, affectations
 * - Génération prélèvements et passage direct en terrain
 */
...
function renderQuickEntry(){
  ...
  // Prélèvements à créer (affectations)
...
function createQuickMission(){
  ...
  render();
  alert('Mission créée avec '+m.prelevements.length+' prélèvement(s) !');
}
